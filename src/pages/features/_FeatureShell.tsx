    ...
    <>
      <div className="mobile-container min-h-screen bg-background pb-nav">
        ...
        <div className="px-4 pt-3 space-y-3">
          {hero && (
            <div className={cn(
              'rounded-[1.25rem] p-4 border bg-gradient-to-br',
              toneStyles
            )}>
              <div className="flex items-center gap-3">
                <span className="w-12 h-12 rounded-2xl bg-background/60 flex items-center justify-center shrink-0">
...
export function PrototypeBanner() {
  return (
    <div className="rounded-2xl px-3.5 py-2.5 flex items-center gap-2 bg-muted/30 border border-border/30">
